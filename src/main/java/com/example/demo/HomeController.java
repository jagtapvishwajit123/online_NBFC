...
public class HomeController {
	...
	public String pay_emi(HttpSession session)
	{
		 if(session.getAttribute("customer") ==null) {
	...
	public String wallet(loan loan,ModelMap m,@RequestParam("email") String email,HttpSession session)
	{
		 if(session.getAttribute("customer") ==null) {
	...
	public String change_pass(@RequestParam("email") String email ,ModelMap m,HttpSession session)
	{
		 if(session.getAttribute("customer") ==null) {
	...
	public String update_pass(@ModelAttribute("c1") Cust c1 , String pass,HttpSession session )
	{
		 if(session.getAttribute("customer") ==null) {
	...
	public String paid_emi(HttpSession session)
	{
		 if(session.getAttribute("customer") ==null) {
	...
	public String emi_pending(HttpSession session)
	{
		 if(session.getAttribute("customer") ==null) {
...
public String addmem(HttpSession session)
{
	 if(session.getAttribute("username") ==null) {
...
public String viewmember(ModelMap m,HttpSession session) 
{
    	 if(session.getAttribute("username") ==null) {
	...
	return "viewMember";
     ...
     public String applied_list(ModelMap m,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     public String deleteappied(@RequestParam("id") int id,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     public String viewfile(@RequestParam("id") int id,ModelMap p,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     public String status(@ModelAttribute("s1") status s1,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     public String getstatus(ModelMap m,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     ////-------deleteAplicant---------////
     @RequestMapping("/deleteAplicant")
     public String deleteAplicant(@RequestParam("id") int id ,HttpSession session)
     {
    	 ss.deleteAplicant(id);
		return "accepted_data";
    ...
    @GetMapping("/rejected_data")
     ...
     public String update(@RequestParam("id") int id,ModelMap e,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     public String pay_transection(@RequestParam("id") int id,ModelMap m,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     */
     ...
     public String paid_transections(ModelMap m,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
  ...
  @GetMapping("/search_result")
     ...
     public String pendingLoan(@RequestParam("id") int id,ModelMap p,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
    ...
    ////------------Pending Details------------////
     ...
     public String pending_details(ModelMap m,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     public String ApprovePending(@RequestParam("id") int id ,ModelMap m,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     public String deletepending(@RequestParam("id") int id,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     public String admin_wallet(ModelMap m,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     public String update_amt(@RequestParam("id") int id,ModelMap m,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
     ...
     @PostMapping("/updatew")
     public String updatew(@ModelAttribute("awallet") admin_wallet awallet,@RequestParam ("camount") String camount,@RequestParam ("amount") String amount,ModelMap m,HttpSession session)
     {
    	 String x,y,z;
    	 x=camount;
    	 y=amount;
     ...
     public String call_req(ModelMap m,HttpSession session)
     {
    	 if(session.getAttribute("username") ==null) {
