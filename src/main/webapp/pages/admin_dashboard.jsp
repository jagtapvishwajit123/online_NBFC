...
<body class="">
              ...
              <div class="card-body ">
               ...
               <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    ...
                    <div class="numbers">
                      <p class="card-category">View Members</p>
                      <p class="card-title"><p>
                    </div>
            ...
            <div class="card card-stats">
              ...
              <a href="applied_loans">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category"> Appied Loans</p>
                      <p class="card-title">RS<p>
                    </div>
                  </div>
                </div></a>
              </div>
              ...
              <div class="card-body ">
               <a href="paid_transections">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Paid Transaction </p>
                      <p class="card-title"><p>
                    </div>
                  </div>
                </div></a>
              ...
              <div class="card-body ">
               <a href="pending_details">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Pending Details</p>
                      <p class="card-title"><p>
                    </div>
                  </div>
                </div></a>
            ...
            <div class="card card-stats">
              ...
              <a href="call_request">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Call Request</p>
                      <p class="card-title"><p>
                    </div>
                  </div>
                </div></a>
    ...
    <a data-toggle="modal" data-target="#loginModal" href="">
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-7 col-md-8">
            <div class="numbers">
              <p class="card-category">Activate Wallet</p>
              <!-- Display wallet amount using forEach loop -->
              <c:forEach var="e" items="${amt}">
                <p class="card-title">${e.amount}</p>
              </c:forEach>
            </div>
          </div>
        </div>
  ...
  <c:otherwise>
    <!-- Execute this code if wallet amount is present -->
    <c:forEach var="e" items="${amt}">
     <a  href="update_wallet?id=${e.id}">
      <div class="card-body">
        <div class="row">
          <div class="col-5 col-md-4">
            <div class="icon-big text-center icon-warning">
          ...
          <div class="col-7 col-md-8">
            <div class="numbers">
              <p class="card-category">Add Amount</p>
              <!-- Display wallet amount using forEach loop -->
              
                <p class="card-title">${e.amount} Rs.</p>
              </c:forEach>
            </div>
          </div>
        </div>
      ...
      <input type="button" value="Calculate EMI" onclick="si()">
    ...
    <script>
     function si(){
    	 ...
    	 var si = loanAmount * interestRate/100 * loanTenure;
    	  document.getElementById("emiResult").innerHTML=si;
      }
     </script>
 </form>
			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="loginModalLabel"
						style="font-family: Times New Roman">Add Amount</h5>
  ...
  <label for="addamount">Amount to Add:</label>
   <input type="text" class="form-control" id="addamount" name="amount" value="${e.id}">
