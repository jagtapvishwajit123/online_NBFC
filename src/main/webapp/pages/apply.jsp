        ...
        <div class="row">
                ...
                <form action="next" method="post" enctype="multipart/form-data">
                 ...
                 <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                     ...
                     <div class="form-outline">
                      <input type="email" id="emailAddress" class="form-control" name="email" readonly value=" <%
          ...
          %>"/>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="text" id="interestRate" class="form-control" value="3" readonly  required oninput="add_number()" name="intrate"  />
                 ...
                 <div class="row">
                   <div class="col-md-6 mb-4">
                     ...
                     <div class="form-outline">
                      <input type="text" id="loanamount"  class="form-control"  oninput="add_number()" name="loanamt"/>
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="text" id="processingfees" class="form-control" value="200" readonly  required  oninput="add_number()" name="pfees"  />
