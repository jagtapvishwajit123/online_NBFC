          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Pending Applied Loan Details</h4>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                     <c:forEach var="e" items="${pl}">
                      ...
                      <tr>
                        ...
                        <a href="DeletePending?id=${e.id}"><button style="font-size:16px; cursor:pointer;background:red;color:white;border-radius:5px;" onclick="myFunction()">Decline&nbsp;<i class="fa fa-close"></i></i></button></a>&nbsp;&nbsp;
                        </td>
